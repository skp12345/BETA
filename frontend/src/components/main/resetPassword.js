...
const ResetPassword = () => {
  return (
    <div>
      <div className='container card' style={{ width: "27rem", borderRadius: "5px", boxShadow: "3px 5px #888888", margin: "20px auto", fontSize: ".9rem", padding: "1rem", background: "rgb(76 175 80 / 14%)" }}>
        <div className='card'>
          <form  >
            <div >
            </div>
            <h3 style={{ textAlign: "center", padding: "1rem" }}>Forgot PassWord </h3>
...
<b>Enter otp</b>    <TextField size='small' id="outlined-basic" label="Otp Here" variant="outlined" color="success" className='w-50' />
        ...
        <div className='card mt-3'>
          <form  >
            ...
            <h3 style={{ textAlign: "center", padding: "1rem" }}>Reset Password </h3>
            <div className="form-group mx-3">
